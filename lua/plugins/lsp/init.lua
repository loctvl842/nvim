return {
...

  {
    ...
    config = function(_, opts)
      ...
      -- local servers = vim.tbl_deep_extend("force", opts.servers, require("config.lsp.servers").servers)
      -- opts.setup = vim.tbl_deep_extend("force", opts.setup, require("config.lsp.servers").setup)
