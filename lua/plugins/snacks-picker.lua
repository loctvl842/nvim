...
return {
  {
    ...
    keys = {
      ...
      { "<leader>sg", function() LazyVim.pick("live_grep", { layout = default })() end, desc = "Grep (Root Dir)" },
      { "<leader>sp", function() LazyVim.pick("live_grep", { layout = default })() end, desc = "Grep (Root Dir)" },
      { "<leader>sG", function() LazyVim.pick("live_grep", { root = false, layout = default })() end, desc = "Grep (cwd)" },
      { "<leader>sL", function() Snacks.picker.lazy({ layout = default }) end, desc = "Search for Plugin Spec" },
      { "<leader>sw", function() LazyVim.pick("grep_word", { layout = default })() end, desc = "Visual selection or word (Root Dir)", mode = { "n", "x" } },
      { "<leader>sW", function() LazyVim.pick("grep_word", { root = false, layout = default })() end, desc = "Visual selection or word (cwd)", mode = { "n", "x" } },
  ...
  -- LSP Integration with custom layouts
  {
    ...
    opts = function()
      ...
      vim.list_extend(keys, {
        ...
        { "<leader>ss", function() Snacks.picker.lsp_symbols({ layout = default  }) end, desc = "LSP Symbols", has = "documentSymbol" },
        { "<leader>sS", function() Snacks.picker.lsp_workspace_symbols({ layout = default  }) end, desc = "LSP Workspace Symbols", has = "workspace/symbols" },
      })
    end,
  },
