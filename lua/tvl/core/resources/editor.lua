return {
...

  {
...

	{
		"kevinhwang91/rnvimr",
		config = function()
			require("tvl.config.ranger")
		end,
	},
  {
		"norcalli/nvim-colorizer.lua",
		config = function()
			require("tvl.config.colorizer")
		end,
  }
}
